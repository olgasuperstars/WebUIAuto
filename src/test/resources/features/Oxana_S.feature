Feature: User story 2 and 7
  Scenario: Log in as administrator make an appointment and cancel it
    ...
    Then I click on element with xpath "//div[contains(text(),'Oksana')]"
    Then I wait for element with xpath "//dd[contains(text(),'Oksana')]" to be present
    Then I wait for 5 sec
